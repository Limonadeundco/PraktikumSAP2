window.addEventListener('load', function() {
    for (let i = 0; i < 2; i++) {
        let recommended_products = document.getElementsByClassName('recommended-product-' + (i + 1));
        console.log(recommended_products);

        let product_name = recommended_products[0].getElementsByClassName('name')[0];
        let product_description = recommended_products[0].getElementsByClassName('description')[0];
